...
// AssignedType อาจเป็น "" ถ้าผู้ใช้ส่งโดยไม่ได้จำแนกเซลล์นี้ (จะถือว่าผิด)
...
// CategoryStat สรุปต่อชนิดเซลล์: นับว่าผู้ใช้แปะไปกี่ใบ และในเฉลยควรเป็นกี่ใบ
...
// Submission แทนการส่ง 1 ครั้งของผู้ใช้
// Score = Correct (1 เซลล์ = 1 คะแนน), Total = จำนวนเซลล์ทั้งหมด
// Passed/CertificateID จะเซ็ตให้ตอน Submit ถ้าคะแนน >= PassPercent
